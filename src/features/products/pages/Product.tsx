...
import { useProduct } from "@/features/products/queries/productQueries";
import { PageLoadingSpinner } from "@/shared/components/LoadingSpinner";
import { ErrorBlock } from "@/shared/components/ErrorBlock";
import { shareToFacebook, shareToX, shareGeneric } from "@/shared/utils/share";
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-gray-50">
              <img
                ...
                onError={(e) => {
                  ...
                  target.onerror = null;
                  target.src = `https://placehold.co/600x600/FAF7F2/D02046?text=${encodeURIComponent(productData.name.slice(0, 15))}`;
                }}
              />
              {productData.badge && (
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          const target = e.currentTarget;
                          target.onerror = null;
                          target.src = `https://placehold.co/80x80/FAF7F2/D02046?text=${index + 1}`;
                        }}
                      />
                    </button>
                  ))}
